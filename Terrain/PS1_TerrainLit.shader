Shader "Custom/PS1_TerrainLit"
{
    Properties
    {
        // --- ДОБАВЛЕНО ДЛЯ PS1 ЭФФЕКТА ---
    ...
    // --- ДОБАВЛЕНА ФУНКЦИЯ ДРОЖАНИЯ PS1 ---
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Shaders/Terrain/TerrainLitInput.hlsl"
            // Для DepthNormals создадим отдельный файл, либо оставим как есть, если тени не критичны, 
            // но для идеала лучше скопировать и его
